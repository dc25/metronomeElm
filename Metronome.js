...
Elm.Metronome.make = function (_elm) {
   "use strict";
   _elm.Metronome = _elm.Metronome || {};
   if (_elm.Metronome.values) return _elm.Metronome.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var HLLLLL = {ctor: "HLLLLL"};
   var HLL = {ctor: "HLL"};
   var HLLL = {ctor: "HLLL"};
   var HL = {ctor: "HL"};
   var Tick = {ctor: "Tick"};
   var SetPattern = function (a) {    return {ctor: "SetPattern",_0: a};};
   var radio = F3(function (address,model,pattern) {
      return _U.list([A2($Html.input,
                     _U.list([$Html$Attributes.disabled(model.started)
                             ,$Html$Attributes.type$("radio")
                             ,$Html$Attributes.checked(_U.eq(model.pattern,pattern))
                             ,A3($Html$Events.on,
                             "change",
                             $Html$Events.targetChecked,
                             function (_p1) {
                                return A2($Signal.message,address,SetPattern(pattern));
                             })]),
                     _U.list([]))
                     ,$Html.text(patternString(pattern))
                     ,A2($Html.br,_U.list([]),_U.list([]))]);
   });
   var SetFob = function (a) {    return {ctor: "SetFob",_0: a};};
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.h1,centerTitle,_U.list([$Html.text("Metronome")]))
              ...
              floatLeft,
              A2($Basics._op["++"],
              _U.list([A2($Html.h2,centerTitle,_U.list([$Html.text("Controls")]))
                      ,$Html.text("Stop To Adjust Fob: ")
                      ,A2($Html.button,_U.list([A2($Html$Events.onClick,address,ToggleStarted)]),_U.list([$Html.text(model.started ? "Stop" : "Start")]))
                      ,A2($Html.br,_U.list([]),_U.list([]))
                      ,A2($Html.br,_U.list([]),_U.list([]))
                      ...
                      _U.list([$Html$Attributes.disabled(model.started)
                              ...
                              function (_p2) {
                                 ...
                                 address,
                                 SetFob(function (p) {    return p / 100.0;}(A2($Maybe.withDefault,100.0,$Result.toMaybe($String.toFloat(_p2))))));
                              })]),
                      _U.list([]))
                      ,A2($Html.br,_U.list([]),_U.list([]))
                      ,$Html.text(A2($Basics._op["++"],"Fob Position: ",$Basics.toString(model.slideRatio)))
                      ,A2($Html.br,_U.list([]),_U.list([]))
                      ,A2($Html.br,_U.list([]),_U.list([]))
                      ,$Html.text("Beat Pattern: ")
                      ,A2($Html.br,_U.list([]),_U.list([]))]),
              A2($Basics._op["++"],
              A3(radio,address,model,HL),
              A2($Basics._op["++"],A3(radio,address,model,HLL),A2($Basics._op["++"],A3(radio,address,model,HLLL),A3(radio,address,model,HLLLLL))))))
              ,A2($Html.div,
              floatLeft,
              _U.list([A2($Html.h2,centerTitle,_U.list([$Html.text("SVG")]))
                      ,A2($Svg.svg,
              ...
              _U.list([A2($Html.h2,centerTitle,_U.list([$Html.text("Collage")]))
                      ,$Html.fromElement(A3($Graphics$Collage.collage,w,h,_U.list([collagePendulum])))]))]));
   });
   var dt = 1.0e-2;
   var update = F2(function (action,model) {
      ...
      {case "Tick": if (model.started) {
                 ...
                 var patternIndex$ = click ? A2($Basics._op["%"],model.patternIndex + 1,$String.length(patternString(model.pattern))) : model.patternIndex;
